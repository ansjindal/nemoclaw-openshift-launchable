...
export const CURRICULUM: Part[] = [
  ...
  {
    id: "build-agent",
    title: "Part III · Build Your Agent",
  ...
  {
    id: "operate",
    title: "Part IV · Make It Yours & Operate",
    subtitle: "Give it identity, then run and govern the layer that manages it",
    accent: "nv",
    lessons: [
      ...
      { slug: "openshell-ops", title: "Control Plane & Policies", blurb: "The gateway, the sandbox CRD, and the deny-by-default policy that governs egress.", minutes: 10, hasLab: true },
      ...
      { slug: "explore", title: "Explore the Control Plane", blurb: "Play with every part: status, logs/audit, policy get & prove, inference, forward.", minutes: 12, hasLab: true },
    ],
  },
  {
    id: "build",
    title: "Part V · Build Something Useful",
  ...
  },
  {
    ...
    subtitle: "Optional add-ons and when something goes sideways",
    lessons: [
