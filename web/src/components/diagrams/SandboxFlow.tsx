  ...
  return (
    <ArchExplorer
      ...
      nodes={[
        ...
        { id: "run", label: "4 · Run", sub: "the agent boots", color: PURPLE, detail: <>The pod starts; the OpenClaw gateway comes up inside it on :18789 and reads its workspace (IDENTITY/SOUL) + config. The Sandbox CR's status flips to Running.</> },
