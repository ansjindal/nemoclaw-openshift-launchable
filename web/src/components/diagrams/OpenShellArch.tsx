  ...
  return (
    <ArchExplorer
      ...
      nodes={[
        ...
        { id: "l7", label: "Inference router", sub: "L7 proxy · inference.local", color: CYAN, detail: <>The <strong>L7 / privacy proxy</strong>. OpenShell-governed sandboxes can call one URL — <code>inference.local</code>. The gateway <strong>strips sandbox-local creds and injects the real backend key + model</strong>, so those agents never hold the upstream key. Change the backend once at the gateway and it propagates to managed sandboxes in ~5s.</> },
