...
const NODES: Record<string, N> = {
  cli: { id: "cli", label: "CLI / SDK / TUI", sub: "openshell …", color: SLATE,
    ...
    ours: <>Installed in the workshop shell and registered against the gateway over plaintext NodePort <code>30808</code> (no OIDC in this dev setup).</> },
  ...
  pvc: { id: "pvc", label: "PVC", sub: "durable state", color: GREEN,
    ...
    ours: <>Bound via the <code>local-path</code> provisioner on the MicroShift node.</> },
